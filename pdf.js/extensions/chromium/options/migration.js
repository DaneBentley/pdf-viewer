  ...
  function migrateRenamedStorage() {
    storageSync.get(
      ...
      function (items) {
        ...
        if (typeof items.showPreviousViewOnLoad === "boolean" && items.viewOnLoad === undefined) {
          if (!items.showPreviousViewOnLoad) {
            ...
            // If showPreviousViewOnLoad was true, ensure viewOnLoad is set to 0 (show previous position)
            storageSync.set(
              {
                viewOnLoad: 0,
              },
        ...
        } else if (typeof items.showPreviousViewOnLoad === "boolean") {
          // Clean up the old setting even if viewOnLoad is already set
