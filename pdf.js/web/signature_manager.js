...
class SignatureManager {
  ...
  #addToolbarButton(signatureData, uuid, description) {
    ...
    deleteButton.classList.add("deleteButton"); // Remove toolbarButton class to avoid pseudo-element issues
    ...
    deleteButton.textContent = "−"; // Set the content directly
    ...
    // Remove the span creation since we're setting textContent directly
